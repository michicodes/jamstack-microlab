        ...
        <form className="w-full max-w-lg" action="/" name="merch" method="POST" data-netlify="true">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <textarea className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="merch-wishes" placeholder="Which Senacor merch do you wanna see next?"/>
